package com.svs.services.employee;

import com.svs.services.employee.model.Employee;
import com.svs.services.employee.repository.EmployeeRepository;
...
@Info(title = "Employee API", version = "1.0", description = "Documentation Department API v1.0")
)
